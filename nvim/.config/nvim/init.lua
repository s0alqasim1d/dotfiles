...
-- vim.g.colorscheme_primary_enable_transparent_bg= 1
vim.cmd(':silent! colorscheme gruvbox-material') -- Set colorscheme to whatever, but fail silently
vim.lsp.set_log_level("debug")-- vim.g['oak_virtualtext_bg'] = 1
vim.g.glow_binary_path = "C:/Users/AlQasim/scoop/shims/"
